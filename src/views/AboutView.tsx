    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7 space-y-4 text-sm text-slate-700 leading-relaxed">
          ...
          <p>
            এই প্রেক্ষাপটে ২০১৬ সালের শুরুতে রাজধানী ঢাকাসহ চট্টগ্রাম, নারায়ণগঞ্জ ও গাজীপুরের অগ্রণী বয়লার অপারেটর ও প্রকৌশলীদের উদ্যোগে ‘বাংলাদেশ বয়লার পরিচারক পরিষদ’ আত্মপ্রকাশ করে। পরবর্তীতে নিয়মতান্ত্রিক প্রক্রিয়ায় নিবন্ধন নং-বিওপি/২০১৬ এর অধীনে পরিষদ একটি প্রাতিষ্ঠানিক রূপ লাভ করে।
          </p>
          <p>
